<script>
  import acchan from "$lib/assets/img/ridho1.png"
...
<div class="flex-middle h-auto gap-2 mt-6
  ...
  <div class="flex-middle flex-col gap-5 ms-10 text-center
              ...
              max-sm:text-justify">
      <!-- First Line -->
      <LinedTitle title="Ridho"/>
      <!-- Introduction -->
      <div class="mx-[1rem]">
        <p1>
          Hello! I am Ridho Januar Rifadha, a Freelancer, Web Developer, and Tech enthusiast.
          Welcome to my Portfolio Website!
        </p1>
        <div class="flex-middle gap-4 pt-5 max-sm:flex-col max-sm:items-start">
          <i class="fa-solid fa-user-tie text-[--theme-green] flex flex-row items-center gap-2"><p2>Freelancer</p2></i>
          <i class="fa-solid fa-chart-line text-[--theme-purple] flex flex-row items-center gap-2"><p2>System Analyst</p2></i>
